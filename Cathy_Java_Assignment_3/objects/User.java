...
public class User {
    ...
    public String bookAppointment(Scanner input, Ink ink) {
        ink.printGreen
        ("Select a # between (1-5) to choose a day\nof the week for your appointment:");
        ...
        switch (choice) {
            case 1:
                System.out.println(Ink.ANSI_YELLOW + 
                "You have booked an appointment\nfor Monday, see you soon!" 
                                   + Ink.ANSI_RESET);
                return "Monday";
            case 2:
                System.out.println(Ink.ANSI_YELLOW + 
                "You have booked an appointment\nfor Tuesday, see you soon!" 
                                   + Ink.ANSI_RESET);
                return "Tuesday";
            case 3:
                System.out.println(Ink.ANSI_YELLOW + 
                "You have booked an appointment\nfor Wednesday, see you soon!" 
                                   + Ink.ANSI_RESET);
                return "Wednesday";
            case 4:
                System.out.println(Ink.ANSI_YELLOW + 
                "You have booked an appointment\nfor Thursday, see you soon!" 
                                   + Ink.ANSI_RESET);
                return "Thursday";
            case 5:
                System.out.println(Ink.ANSI_YELLOW + 
